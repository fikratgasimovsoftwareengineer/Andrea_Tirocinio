class Dog:
    ...
    @classmethod
    def create_default_dog(cls):
        # Predefined name and age
        return cls(name="Belarus", age=4, breed="Hokkaido")
...
# Creating a new dog with predefined name and age using the class method
default_dog = Dog.create_default_dog()
print(default_dog)  # Belarus, 4, Hokkaido

# Printing the string representation of the dogs
print(dog1)  # Output: Jet is a 3-year-old San Bernardo.
print(dog2)  # Output: Ken is a 5-year-old Alaskan Malamute.
